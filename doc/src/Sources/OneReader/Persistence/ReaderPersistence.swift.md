...
commit. Source-position fractions must be finite and within 0...1, and their
display labels are bounded before encoding. Annotation fetch order is stable,
history is bounded, progress is one
